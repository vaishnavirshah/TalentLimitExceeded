...
width: double.infinity,
    child: new Carousel(
      ...
      ].map((bgImg) => new Image(image: bgImg,/* width: MediaQuery.of(context).size.width*0.2, height: MediaQuery.of(context).size.height*0.6,*/fit: BoxFit.fitWidth,)).toList(),
      boxFit: BoxFit.cover,
      autoplay: true,
      autoplayDuration: Duration(seconds:5),dotSize:4,
