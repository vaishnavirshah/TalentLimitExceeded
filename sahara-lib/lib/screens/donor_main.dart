...
width: MediaQuery.of(context).size.width*0.25,
    child: new Carousel(
      ...
      ].map((bgImg) => new Image(image: bgImg, width: MediaQuery.of(context).size.width*0.25, height: MediaQuery.of(context).size.width*0.25, fit: BoxFit.cover)).toList(),
      boxFit: BoxFit.cover,
      autoplay: true,
...
width: double.infinity,
    child: new Carousel(
      ...
      boxFit: BoxFit.cover,
      autoplay: true,
      autoplayDuration: Duration(seconds:15),dotSize: 5,
    ),
  ),
