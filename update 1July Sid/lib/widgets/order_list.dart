    ...
    return Container(
     margin: EdgeInsets.symmetric(vertical: 0,horizontal: 2),
        ...
        padding: EdgeInsets.all(10),
         decoration: BoxDecoration(gradient:LinearGradient(begin:Alignment.topCenter,end:Alignment.bottomRight,colors:[Colors.black,Colors.white]),),
                              ...
                              children: <Widget>[
                               ...
                               // Container(
                                 ...
                                 // SingleChildScrollView(
                                    //  child:
                                      documents.length==0?Center(child: Text('No Donations', style:TextStyle(color:Colors.white)),): Card(
                                      //elevation: 40,
                                     // borderOnForeground: true,
                                     color: Colors.amber[50],
                                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18),side: new BorderSide(color: Colors.black, width: 0.0)),
                                        child: Padding(
