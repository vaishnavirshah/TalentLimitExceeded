        ...
        children: <Widget>[
          ...
          Container(
            ...
            (
              ...
              leading:Icon(Icons.history,color: Colors.black,size: 26,),
              title:Text('Your Orders',style:TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold)),
              onTap:() {
          ...
          Container(
            ...
            (
              ...
              leading:Icon(Icons.info, color: Colors.black,size: 26,),
              title:Text('About us',style:TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold)),
              onTap:() {
                 Navigator.of(context).pop();
          ...
          Container(
            ...
            (
              contentPadding: EdgeInsets.all(10),
              leading:Icon(Icons.exit_to_app,color: Colors.black,size: 26,),
              title:Text('Logout',style:TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.bold)),
              onTap:() {
                value=1;
                if(value==1)
                {
