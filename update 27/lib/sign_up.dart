    ...
    if (isValid) {
      ...
      try {
        ...
        Navigator.of(context)
            .pushReplacement(MaterialPageRoute(builder: (ctx) => TCpage(isDonor)));
                          ...
                          decoration: InputDecoration
                               (
                                ...
                                suffixIcon: IconButton
                                 (
                                icon: _showPwd?Icon(Icons.visibility_off,color:Colors.black):Icon(Icons.visibility,color:Colors.black),
                                onPressed: ()=> password(),
                                 )
                               ),
                              style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),
                         ...
                         // validation();
                          ...
                          decoration: InputDecoration
                               (
                                ...
                                suffixIcon: IconButton
                                 (
                                icon: _showCnfrmPwd?Icon(Icons.visibility_off,color:Colors.black):Icon(Icons.visibility,color:Colors.black),
