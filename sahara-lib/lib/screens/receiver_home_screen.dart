...
class _ReceiverHomeScreenState extends State<ReceiverHomeScreen> {
  ...
  Widget getDonorTile(int i, final documents) {
    ...
    DateTime date = documents[i]['time1'].toDate();
                                ...
                                child: isLoading
                                    ...
                                    : Container(
                                        child: ListView.builder(
                                            ...
                                            //shrinkWrap: true,
                                            itemBuilder: (ctx, i) {
                                               DateTime date2 = documents[i]['time1'].toDate();

                                               if(date2.isBefore(DateTime.now()))
                                               {
                                                     Firestore.instance.collection('orders').document(documents[i]['id']).delete();
                                                     count2=count2+1;
                                                     if(count2==count1)
                                                     {
                                                      return Container(
