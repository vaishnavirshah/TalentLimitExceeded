            ...
            content: FittedBox(
              ...
              SizedBox(height:MediaQuery.of(context).size.height*0.005,),
               ...
               SizedBox(height:MediaQuery.of(context).size.height*0.01,),
                Container(child: Text('Food Category: ',style: TextStyle(fontSize:20),),margin:EdgeInsets.all(10),),
                CheckboxListTile(
                  title: Text('Veg: ',style: TextStyle(fontSize:19),),
                  value: isVege,
                  onChanged: (value) {
                    setState(() {
                      isVege = value;
                ...
                CheckboxListTile(
                  title: Text(
                  'Non-Veg: ',style: TextStyle(fontSize:19)
                  ),
                  value: isNVeg,
                  onChanged: (value) {
                    setState(() {
